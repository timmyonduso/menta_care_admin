...
import Logo from '../../images/logo/mental-health.png';
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <div className="flex items-center gap-2">
          ...
          <span className="text-2xl font-large text-white">Menta Care</span>
        </div>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === '/clients' ||
              ...
              {/* <!-- Menu Item Professional Management --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/forms' || pathname.includes('forms')
                }
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            ...
                            >
                              Referral Feedback and Outcomes
                            </NavLink>
                          </li>
                        </ul>
                      </div>
              ...
              {/* <!-- Menu Item Referrals and Partnerships --> */}
              ...
              {/* <!-- Menu Item Announcements and Notifications --> */}
              <SidebarLinkGroup
                activeCondition={
